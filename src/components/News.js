...
export class News extends Component {
    ...
    */
    ...
    async componentDidMount() {
        ...
        let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=b10258dc32624b63b34b96b5e083de1f&page=1";
    ...
    handlePrevClick = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=b10258dc32624b63b34b96b5e083de1f&page=${this.state.page - 1}`;
        let data = await fetch(url);
        let parsedData = await data.json()
