...
export class News extends Component {
    ...
    */
    ...
    async componentDidMount() {
        ...
        let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=b10258dc32624b63b34b96b5e083de1f&page=1&pageSize=14";
    ...
    handlePrevClick = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=b10258dc32624b63b34b96b5e083de1f&page=${this.state.page - 1}&pageSize=14`;
        let data = await fetch(url);
        let parsedData = await data.json()
        ...
        return (
            <div className='container my-3 '>
                ...
                <div className="container d-flex justify-content-between">
                    ...
                    <button disabled={this.state.page>2} type="button" class="btn btn-dark" onClick={this.handleNextClick}> Next  &rarr;</button>
                </div>
