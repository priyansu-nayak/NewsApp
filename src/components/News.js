...
export class News extends Component {
    ...
    */
    ...
    async componentDidMount() {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&apiKey=b10258dc32624b63b34b96b5e083de1f&page=1&pageSize=${this.props.pageSize}`;
    ...
    handlePrevClick = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&apiKey=b10258dc32624b63b34b96b5e083de1f&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
